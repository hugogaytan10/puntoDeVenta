...
namespace PUNTO_DE_VENTA.POJOS
{
    class clsTicket
    {
        ...
        string line = null;
        //VARIABLE PARA GUARDAR EL TICKET EN TXT EN LA PC
        string documento = "";
        ...
        public void AddHeaderLine(string line)
        {
            ...
            //lo agregamos al txt que guradaremos
            documento += line + "\n";
            
            documento += nombreTicket + "\n";
        }
        ...
        public void AddTotal(string name, string price)
        {
            ...
            documento += name + "\t" + price + "\n";
        }
        public void AddIva(string name, double price)
        {
            OrderTotal newTotal = new OrderTotal('?');
            
            
            totales.Add(newTotal.GenerateTotal(name, price.ToString()));
            documento += name + "\t" + price + "\n";
        ...
        private void DrawImage()
        {
            if (headerImage != null)
            {
                try
                {
                    ...
                    gfx.DrawImage(headerImage, new Point((int)10, (int)YPosition()));
                    double height = ((double)headerImage.Height / 70) * 15;
